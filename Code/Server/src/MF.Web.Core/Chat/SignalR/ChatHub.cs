...
namespace MF.Web.Chat.SignalR
{
    ...
    public class ChatHub : OnlineClientHubBase
    {
        ...
        public async Task<string> SendMessage(SendChatMessageInput input)
        {
            ...
            var sender = new UserIdentifier(CurrentTenantId, CurrentUserId.Value);
        ...
        protected override IOnlineClient CreateClientForCurrentConnection()
        {
