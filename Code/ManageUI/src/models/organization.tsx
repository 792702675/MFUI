...
export default {
    ...
    effects: {
        ...
        *createOrganizationUnit({ payload }, { call, put }) {
            const { success, result } = yield call(...createApiAuthParam({
                method: new api.OrganizationUnitApi().createOrganizationUnit,
                payload: payload
            }));
            if (success) {
                yield put({
        ...
        *updateOrganizationUnit({ payload }, { call, put }) {
            const { success, result } = yield call(...createApiAuthParam({
                method: new api.OrganizationUnitApi().updateOrganizationUnit,
                payload: payload
            }));
            if (success) {
                yield put({
                ...
                notification.success({
                    message: "修改成功!",
                    description:""
                    //  <span>您已成功修改组织机构 < /span>
                });
            }
        },
        *moveOrganizationUnit({ payload }, { call, put }) {
            const { success, result } = yield call(...createApiAuthParam({
                method: new api.OrganizationUnitApi().moveOrganizationUnit,
                payload: payload
            }));
            if (success) {
                yield put({
        ...
        *deleteOrganizationUnit({ payload }, { call, put }) {
            const { success, result } = yield call(...createApiAuthParam({
                method: new api.OrganizationUnitApi().deleteOrganizationUnit,
                payload: payload
            }));
            if (success) {
                yield put({
        ...
        *getOrganizationUnitUsers({ payload }, { call, put }) {
            ...
            const { success, result } = yield call(...createApiAuthParam({
                method: new api.OrganizationUnitApi().getOrganizationUnitUsers,
                payload: payload
            }));
            if (success) {
                yield put({
        ...
        *getOrganizationUnitJoinableUserList({ payload }, { call, put }) {
            ...
            const { success, result } = yield call(...createApiAuthParam({
                method: new api.OrganizationUnitApi().getOrganizationUnitJoinableUserList,
                payload: payload
            }));
            if (success) {
                yield put({
        ...
        *addUserToOrganizationUnit({ payload }, { call, put }) {
            const { success, result } = yield call(...createApiAuthParam({
                method: new api.OrganizationUnitApi().addUserToOrganizationUnit,
                payload: payload
            }));
            if (success) {
                notification.success({
        ...
        *removeUserFromOrganizationUnit({ payload }, { call, put }) {
            const { success, result } = yield call(...createApiAuthParam({
                method: new api.OrganizationUnitApi().removeUserFromOrganizationUnit,
                payload: payload
            }));
            if (success) {
                notification.success({
    ...
    subscriptions: {
        setup({ dispatch, history }) {
            return history.listen(({ pathname, state }) => {
                if (pathname.toLowerCase() == '/home/organization'.toLowerCase()) {
                    dispatch({
                        type: 'getOrganizationUnits'
                    });
                }
