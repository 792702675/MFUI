...
class HomeIndex extends React.Component {
    componentDidMount() {
        let _this=this;
        let myChart = echarts.init(_this.refs.zhu);
        myChart.setOption({
            title: {
                text: '某地区蒸发量和降水量',
                subtext: '纯属虚构'
        ...
        //第二个图
        let myChart2 = echarts.init(_this.refs.lei);
        ...
        myChart2.setOption({
            ...
            series: [{
                ...
                data: [{
                    ...
                    value: 8844,
                        symbol: 'image://https://www.echartsjs.com/data/asset/img/hill-Qomolangma.png',
                    symbolSize: ['200%', '105%'],
                    symbolPosition: 'end',
                    z: 10
                }, {
                    value: 5895,
                        symbol: 'image://https://www.echartsjs.com/data/asset/img/hill-Kilimanjaro.png',
                    symbolSize: ['200%', '105%'],
                    symbolPosition: 'end'
                }],
                markLine: {
        ...
        //第三图
        let myChart3 = echarts.init(_this.refs.zhe);
        var symbols = [
        ...
        //第四图
        let myChart4 = echarts.init(_this.refs.qi);
        ...
        var data1 = genData(5000);
        var data2 = genData(5000, 10);
        myChart4.setOption({
            title: {
            ...
            <div>
                <Row>
                    <Col xl={11} lg={24} style={{ background: '#fff', marginTop: 20 }}>
                        <div ref="zhu" style={{height:450}}></div>
                        </Col>
                    <Col xl={{ span: 11, offset: 1 }} lg={24} style={{ background: '#fff', marginTop: 20 }}>
                        <div ref="lei" style={{ height: 450 }}></div>
                        </Col>
                    <Col xl={11} lg={24} style={{ background: '#fff', marginTop: 20 }}>
                        <div ref="zhe" style={{ height: 450 }}></div>
                        </Col>
                    <Col xl={{ span: 11, offset: 1 }} lg={24} style={{ background: '#fff', marginTop: 20 }}>
                        <div ref="qi" style={{ height: 450 }}></div>
                       </Col>
                </Row>
            </div>
        );
