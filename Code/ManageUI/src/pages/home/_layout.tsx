...
import BindingThirdParty from '../../components/Home/BindingThirdParty';
import {
    Layout,
    Menu,
    Icon,
                    ...
                    if (menu.target == '_blank') {
                        return (
                            <Menu.Item key={menu.name}>
                                <a href={"/home"+menu.url} target={menu.target}>
                                    {menu.icon ? <Icon type={menu.icon} /> : null}
                                    <span>{menu.displayName}</span>
                                </a>
                            </Menu.Item>
                        ...
                        return (
                            <Menu.Item key={menu.url}>
                                <Link to={"/home" +menu.url} target={menu.target}>
                                    {menu.icon ? <Icon type={menu.icon} /> : null}
                                    <span>{menu.displayName}</span>
                                </Link>
                            </Menu.Item>
        ...
        const notificationsList = (
            <div>
                ...
                <div className={styles.notificationsFooter}>
                    <a href="#/home/notification">查看全部通知</a>
                </div>
            </div>
        );
