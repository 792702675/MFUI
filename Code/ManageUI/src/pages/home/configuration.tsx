...
function Configuration({ dispatch, allSetting, form, mode, passwordComplexitySetting, saveLoading }) {
...
Configuration = connect((state) => {
    return {
        ...state.configuration,
        saveLoading: state.loading.effects['configuration/updateAllSettings'],
    };
})(Configuration);
